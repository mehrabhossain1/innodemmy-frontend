...
export default function UpcomingWebinarPage() {
    ...
    return (
        <div ref={topRef} className="min-h-screen bg-background">
            {/* Header */}
            <div className="bg-gradient-to-br from-accent/10 via-primary/10 to-background border-b border-border">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-gradient-to-r from-accent to-primary text-white border-0 text-sm px-4 py-2">
                            {filteredWebinars.length} Upcoming
                        </Badge>
                    </div>
                </div>
            </div>
                                ...
                                <button
                                    ...
                                    className={`shrink-0 flex items-center gap-2 px-4 py-3 rounded-xl border transition-all duration-300 ${
                                        activeCategory === category.id
                                            ...
                                            : "bg-white dark:bg-card border-gray-200 dark:border-border hover:border-accent text-foreground hover:bg-gray-50 dark:hover:bg-accent/10"
                                    }`}
                                >
