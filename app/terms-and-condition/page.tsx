            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary/10 via-primary/5 to-background">
                <div className="container mx-auto text-center">
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed max-w-4xl mx-auto">
                        Welcome to Innodemy! By accessing or using our website,
                        mobile app, or services (including online courses, live
                        sessions, and recorded classes), you agree to follow the
                        Terms and Conditions outlined below. Please read them
                            ...
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        You must be at least the legal age of
                                        consent in your country to create an
                                        account and use our services. If you are
                                        under this age, you may only use
                                        Innodemy with parental or guardian
                                        permission.
                                    </p>
                                </div>
                            </div>
                        ...
                        <CardContent className="p-8">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        You agree to notify Innodemy immediately
                                        if you suspect unauthorized use of your
                        ...
                        <CardContent className="p-8">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed mb-4">
                                        By using Innodemy, you are granted a
                                        limited, non-exclusive, non-transferable
                                        license to access and use the platform,
                                        courses, live sessions, and recorded
                                        content solely for personal learning and
                                        non-commercial purposes.
                                    </p>
                                    <p className="text-muted-foreground leading-relaxed mb-4">
                                        You may not copy, record, share, sell,
                                        or create derivative works from any
                                        content without prior written consent,
                                        nor use the platform for disruptive,
                                        illegal, or harmful activities.
                                    </p>
                                    <p className="text-muted-foreground leading-relaxed">
                                        All content, designs, logos, and
                                        materials are owned by or licensed to
                                        Innodemy and protected by intellectual
                                        property laws.
                                    </p>
                                </div>
                            </div>
                                            ...
                                            <ul className="text-muted-foreground space-y-2 ml-4">
                                                <li className="flex items-start gap-2">
                                                    ...
                                                    <span>
                                                        ...
                                                        our Refund Policy, which
                                                        is clearly stated at the
                                                        time of purchase.
                                                    </span>
                                                </li>
                                                <li className="flex items-start gap-2">
                        ...
                        <CardContent className="p-8">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed mb-4">
                                        All course materials, videos, designs,
                                        text, graphics, logos, images, and any
                                        other content made available through
                                        Innodemy are owned by Innodemy or its
                                        partners and are protected by
                                        intellectual property laws.
                                    </p>
                                    <p className="text-muted-foreground leading-relaxed">
                                        You are welcome to use these materials
                                        for your personal learning only.
                                        However, you may not copy, modify,
                                        share, distribute, resell, or use them
                                        for commercial purposes without prior
                                        written permission from Innodemy.
                                    </p>
                                </div>
                            </div>
                        </CardContent>
                        ...
                        <CardContent className="p-8">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <p className="text-muted-foreground leading-relaxed">
                                            We are fully committed to protecting
                                            your personal information and
                                            keeping it secure. To prevent
                                            unauthorized access or disclosure,
                                            we have implemented strict physical,
                        ...
                        <CardContent className="p-8">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed mb-4">
                                        At Innodemy, we want every learner to
                                        enjoy a safe and positive experience.
                                        However, to protect our community and
                                        maintain the integrity of our platform,
                                        we may suspend or permanently terminate
                                        your account in certain situations.
                                    </p>
                                    <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
                                        <p className="text-sm text-red-700 dark:text-red-300">
                                            If you feel your account has been
                                            suspended or terminated by mistake,
                                            you may contact our support team at
                                            innodemy360@gmail.com to request a
                                            review.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <CardContent className="p-8">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed mb-4">
                                        The Innodemy platform, courses, and all
                                        related materials are provided as they
                                        are, depending on availability. By using
                                        the platform, you understand and accept
                                        that you are doing so at your own
                                        responsibility.
                                    </p>
                                    <p className="text-muted-foreground leading-relaxed">
                                        To the fullest extent permitted by law,
                                        Innodemy and its officers, directors,
                                        employees, partners, and agents disclaim
                                        all warranties, express or implied,
                                        regarding the platform and your use of
                                        it.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        ...
                                        time. Any changes will be posted on our
                                        website or app. Continued use of our
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary to-primary/80">
                <div className="container mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-lg text-primary-foreground/90 leading-relaxed mb-4">
                        ...
                        Conditions or need clarification on any point, please
