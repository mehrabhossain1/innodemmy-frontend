    ...
    const requirements = [
        {
            ...
            title: "Laptop/Workstation: Minimum 8GB RAM (16GB+ recommended for EDA tools)",
            gradient: "from-blue-500 to-blue-600",
        },
        {
            image: "https://img.icons8.com/color/96/linux.png",
            title: "Operating System: Linux (Ubuntu/CentOS)",
                ...
                {requirements.map((requirement, index) => {
                    return (
                        <div key={index} className="relative group h-full">
                            {/* Card */}
                            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 h-full flex flex-col justify-center">
                                {/* Number Badge */}
