    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-2 gap-5">
                {/* Modules */}
                <div className="group relative bg-gradient-to-br from-white to-red-50/30 rounded-3xl p-6 shadow-lg shadow-red-100/50 border border-red-100/50 hover:shadow-xl hover:shadow-red-200/50 hover:-translate-y-1 transition-all duration-300">
                    <div className="flex flex-col items-center text-center space-y-4">
                        <div className="relative">
                            <div className="absolute inset-0 bg-red-500/20 blur-xl rounded-full group-hover:bg-red-500/30 transition-all duration-300"></div>
                            <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center shadow-lg shadow-red-500/30 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
                {/* Batch Number */}
                <div className="group relative bg-gradient-to-br from-white via-white to-slate-50/50 rounded-2xl p-5 shadow-md shadow-slate-200/50 border border-slate-200/60 hover:shadow-lg hover:shadow-slate-300/50 hover:border-red-200 transition-all duration-300 overflow-hidden">
                    ...
                    <div className="relative flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-red-100 to-red-200/80 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
