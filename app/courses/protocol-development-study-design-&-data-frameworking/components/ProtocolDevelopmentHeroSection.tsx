...
interface ProtocolDevelopmentHeroSectionProps {
    courseData: {
        title: string;
        description: string;
        price: number;
...
export default function ProtocolDevelopmentHeroSection({
    courseData,
    onEnrollClick,
}: ProtocolDevelopmentHeroSectionProps) {
    // Generate consistent rating values
    const displayRating = courseData.rating || 4.6;
    const displayTotalRatings = courseData.totalRatings || 89;
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="mb-6 w-full">
                            <div
                                className="text-gray-700 dark:text-gray-300 text-base leading-relaxed whitespace-pre-line text-justify"
                    ...
                    <div className="lg:col-span-1 lg:sticky lg:top-4 lg:self-start">
                        {/* Course Image */}
                        <div className="relative aspect-video rounded-xl overflow-hidden shadow-lg mb-4 border border-gray-100 dark:border-gray-700">
                            <Image
                            ...
                            <div className="p-5">
                                <div className="grid grid-cols-2 gap-3">
                                    <button
                                        ...
                                        className="flex items-center justify-center gap-2 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 rounded-lg py-3 transition-all duration-200 hover:shadow-sm"
                                    >
                                        <svg
