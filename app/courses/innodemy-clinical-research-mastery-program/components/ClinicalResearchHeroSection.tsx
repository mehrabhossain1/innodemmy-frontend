                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 lg:sticky lg:top-4 lg:self-start">
                        ...
                        >
                            ...
                            {/* Video Corner Label */}
                            <div className="absolute top-3 left-3 bg-primary/90 dark:bg-primary backdrop-blur-sm text-white px-3 py-1.5 rounded-lg shadow-lg flex items-center gap-2">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                            {/* Pricing Section */}
                            <div className="bg-gradient-to-br from-primary/8 via-primary/5 to-white dark:from-primary/20 dark:via-primary/10 dark:to-gray-800 p-5 border-b border-gray-100 dark:border-gray-700">
