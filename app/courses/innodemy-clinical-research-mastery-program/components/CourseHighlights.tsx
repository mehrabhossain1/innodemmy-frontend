    ...
    return (
        <div className="space-y-6">
                ...
                <div className="group relative bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-6 shadow-lg shadow-blue-100/50 border border-blue-100/50 hover:shadow-xl hover:shadow-blue-200/50 hover:-translate-y-1 transition-all duration-300">
                    <div className="flex flex-col items-center text-center space-y-4">
                        <div className="relative">
                            ...
                            <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/30 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
                {/* Batch Number */}
                <div className="group relative bg-gradient-to-br from-white via-white to-slate-50/50 rounded-2xl p-5 shadow-md shadow-slate-200/50 border border-slate-200/60 hover:shadow-lg hover:shadow-slate-300/50 hover:border-blue-200 transition-all duration-300 overflow-hidden">
