...
interface BiostatisticsHeroSectionProps {
    courseData: {
        title: string;
        description: string;
        price: number;
...
export default function BiostatisticsHeroSection({
    courseData,
    onEnrollClick,
}: BiostatisticsHeroSectionProps) {
    // Generate consistent rating values
    const displayRating = courseData.rating || 4.7;
    const displayTotalRatings = courseData.totalRatings || 167;
