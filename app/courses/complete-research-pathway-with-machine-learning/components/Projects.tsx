...
export default function Projects() {
    const projects = [
        ...
        {
            number: 2,
            title: "Handwritten Digits Classification using KNN",
            image: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800&q=80",
        },
        {
            number: 3,
            title: "Image Classification on MNIST using CNN",
            image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&q=80",
        },
        {
            number: 4,
            title: "Activity Recognition from Sensor Data",
            image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&q=80",
        },
        {
            number: 5,
            title: "Question Answering with Small Language Model",
            image: "https://images.unsplash.com/photo-1655635643532-fa9ba2648cbe?w=800&q=80",
        },
    ];
