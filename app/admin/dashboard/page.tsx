...
import { User, Course, Users, BookOpen, DollarSign, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'enrollments' && (
          <div>
            <h2 className="text-2xl font-bold mb-6">Enrollment Requests</h2>
            <div className="grid gap-4">
                  ...
                  <CardContent className="p-6">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Course: {enrollment.course.title}</p>
                        <p className="text-sm text-gray-500">Amount: ${enrollment.paymentAmount}</p>
                        <p className="text-xs text-gray-500">
                      ...
                      <div className="flex flex-col space-y-2">
                        ...
                        {enrollment.status === 'pending' && (
                          <div className="flex space-x-2">
                            <Button 
                              size="sm" 
                              onClick={() => handleEnrollmentStatus(enrollment._id, 'approved')}
                            >
                              Approve
                            </Button>
                            <Button 
                              size="sm" 
                              variant="destructive"
                              onClick={() => handleEnrollmentStatus(enrollment._id, 'rejected')}
                            >
                              Reject
                            </Button>
                          </div>
