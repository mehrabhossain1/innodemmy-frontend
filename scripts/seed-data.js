...
async function seedData() {
    ...
    try {
        ...
        const existingAdmin = await db
            .collection("users")
            .findOne({ email: "admin@innodemmy.com" });
        if (!existingAdmin) {
        ...
        const sampleCourses = [
            {
                ...
                description:
                    "Learn full-stack web development with HTML, CSS, JavaScript, React, Node.js, and MongoDB.",
                price: 299,
                instructor: "John Doe",
                duration: "12 weeks",
                level: "beginner",
                ...
                modules: [
                    {
                        ...
                        lessons: [
                            ...
                            {
                                title: "CSS Styling",
                                description: "CSS basics and styling",
                                duration: "3 hours",
                            },
                        ],
                    },
            ...
            },
            {
                ...
                description:
                    "Master data science with Python, pandas, numpy, matplotlib, and machine learning.",
                price: 399,
                ...
                modules: [
                        ...
                        lessons: [
                            {
                                ...
                                description: "Setting up React Native",
                                duration: "2 hours",
                            },
                            {
                                title: "Navigation",
                    ...
                    },
                    {
                        ...
                        lessons: [
                            ...
                            {
                                title: "Context API",
                                description: "React Context for state",
                                duration: "3 hours",
                            },
                        ],
                    },
