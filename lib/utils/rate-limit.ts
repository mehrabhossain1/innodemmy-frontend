...
export const RATE_LIMITS = {
    ...
    ENROLLMENT: { windowMs: 60 * 1000, maxRequests: 3 }, // 3 enrollment submissions per minute
    FORM_SUBMIT: { windowMs: 60 * 1000, maxRequests: 5 }, // 5 form submissions per minute (consultation, webinar)
    API_GENERAL: { windowMs: 60 * 1000, maxRequests: 30 }, // 30 requests per minute (general GET endpoints)
};
