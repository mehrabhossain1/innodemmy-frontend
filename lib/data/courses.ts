...
Participants will master critical appraisal, gap analysis, study design selection, ethical compliance with BMRC guidelines, and complete protocol writing. By the end of this program, learners will be capable of developing BMRC-compliant research proposals ready for ethical review and implementation.`,
    ...
    faq: [
      {
        question: 'Do I need prior research experience to join this course?',
      ...
      {
        question: 'Will I be able to submit a BMRC proposal after this course?',
      ...
      {
        question: 'Is this course recognized by BMRC or any medical institutions?',
    ...
    modules: [
      {
        classNumber: 1,
        moduleTitle: 'Tier 1 – Research Foundation & Scientific Literacy',
        topics: [
      ...
      {
        classNumber: 2,
        moduleTitle: 'Tier 2 – Protocol Development, Study Design & Data Frameworking',
        topics: [
